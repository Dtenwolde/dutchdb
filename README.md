...
EendDB is a DuckDB extension that lets you write SQL queries in Dutch. Load the extension, enable the parser, and query away using fully Dutch keywords.

> **"Eend"** is Dutch for **"duck"** — so EendDB is literally DuckDB in Dutch.
...
- `eenddb.duckdb_extension` is the loadable binary as it would be distributed.
